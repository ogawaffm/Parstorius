...
package com.ogawa.parstorius.formatter.formatting;
...
public interface FormatterFormatDefaultsTester<T, F extends Formatter<T, F>> {

    abstract F getDefaultFormatter();

    abstract T getTestParseDefault(PARSE_RESULT_CAUSE formatDefault);

    @Test
    default void testParseDefaultsGetterSetter() {
        Formatter<T, F> f = getDefaultFormatter();
